...
pushd "%REPO_ROOT%"
"%CYTRADE_PYTHON%" "scripts\run\run_main_seal_follow_monitor_session.py" --pool-output "data\stock_pools\manual\main_seal_follow_manual_pool.csv" --skip-pool-collect %*
