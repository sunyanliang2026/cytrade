...
def test_get_logger_does_not_reset_summary_mode(tmp_path):
    LogManager._instance = None
...
def test_summary_filter_keeps_warnings_visible():
    record = logging.LogRecord("x", logging.WARNING, __file__, 1, "warning message", (), None)
